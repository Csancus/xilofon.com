...
const content: Record<string, { sections: Section[] }> = {
  hu: {
    sections: [
      ...
      { h: "3. A szolgáltatások leírása", body: ["Weboldal csomag (188 EUR/év): One-pager weboldal tervezése, elkészítése, domain regisztráció, hosting, szerkesztési hozzáférés és alapszintű SEO.", "Facebook & Social Media kezelés: Közösségi média tartalom és hirdetések.", "Google Business Profil: Profil létrehozása és optimalizálása.", "SEO tanácsadás: Keresőoptimalizálási tanácsadás és audit."] },
      { h: "4. A weboldal csomag részletei", body: ["Az éves díj 188 EUR + ÁFA, amelybe beletartozik: one-pager weboldal, domain regisztráció (1 év), hosting és SSL tanúsítvány, szerkesztési hozzáférés, alapszintű SEO, kapcsolatfelvételi form, support (e-mailben)."] },
  ...
  en: {
    sections: [
      ...
      { h: "3. Description of services", body: ["Website package (€188/year): Design and build of a one-page website, domain registration, hosting, editing access and basic SEO.", "Facebook & Social Media management: Social media content and advertising.", "Google Business Profile: Profile creation and optimisation.", "SEO consulting: Search engine optimisation advice and audit."] },
      { h: "4. Website package details", body: ["The annual fee is €188 + VAT and includes: one-page website design and build, domain registration (1 year), hosting and SSL certificate, editing access, basic SEO, contact form, email support."] },
  ...
  hr: {
    sections: [
      ...
      { h: "3. Opis usluga", body: ["Web paket (188 EUR/god): Dizajn i izrada jednospratne web stranice, registracija domene, hosting, pristup uređivanju i osnovna SEO optimizacija.", "Facebook & upravljanje društvenim mrežama: Sadržaj i oglašavanje na društvenim mrežama.", "Google Business profil: Izrada i optimizacija profila.", "SEO savjetovanje: Savjetovanje i revizija optimizacije za tražilice."] },
      { h: "4. Detalji web paketa", body: ["Godišnja naknada iznosi 188 EUR + PDV i uključuje: dizajn i izradu jednospratne stranice, registraciju domene (1 godina), hosting i SSL certifikat, pristup uređivanju, osnovu SEO optimizaciju, kontakt formu, podršku putem e-maila."] },
  ...
  ro: {
    sections: [
      ...
      { h: "3. Descrierea serviciilor", body: ["Pachet website (188 EUR/an): Design și realizare site one-page, înregistrare domeniu, hosting, acces editare și SEO de bază.", "Gestionare Facebook & Social Media: Conținut pentru rețele sociale și publicitate.", "Profil Google Business: Creare și optimizare profil.", "Consultanță SEO: Consultanță și audit pentru optimizarea motoarelor de căutare."] },
      { h: "4. Detalii pachet website", body: ["Taxa anuală este de 188 EUR + TVA și include: design și realizare site one-page, înregistrare domeniu (1 an), hosting și certificat SSL, acces editare, SEO de bază, formular de contact, suport prin e-mail."] },
