    ...
    <>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-5">
              A Xilofon csapata{" "}
              <span className="text-violet-400">a kis vállalkozások oldalán áll</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-violet-50 rounded-3xl p-8 border border-violet-100">
              <div className="text-center">
                <div className="text-5xl font-bold text-violet-600 mb-2">140 €</div>
                ...
                <div className="border-t border-violet-200 my-6" />
            ...
            {values.map((v) => (
              <div key={v.title} className="bg-white rounded-2xl p-7 border border-slate-100">
                <div className="w-12 h-12 rounded-xl bg-violet-50 flex items-center justify-center mb-5">
                  <v.icon size={22} className="text-violet-600" />
                </div>
      ...
      <section className="py-16 bg-slate-900 text-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Dolgozzunk együtt!</h2>
